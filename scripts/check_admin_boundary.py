...
ROOT=Path(__file__).resolve().parents[1]; REPO="skywatcher-pr"; FORBIDDEN=("AdminKit","federation-admin-workstation","lockstep.override","certification.issue","deployment.promote","PRII_MANAGER_BOOTSTRAP_NONCE")
