"""Read-only SATIM/GATIM proximity bridge.

The bridge emits spatial links only. It does not assert causation, site meaning, or flight behavior.
"""
...
from tools.gatim.core.dedupe import haversine_m
    ...
    for row in gatim_rows:
        ...
        for fn in fn_points:
            ...
            if distance <= radius_m:
                status = "coordinate_overlap" if distance <= 25 else "nearby_FN"
                links.append(
                    SATIMGATIMLink(
