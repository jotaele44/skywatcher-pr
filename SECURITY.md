...
- Preferred: open a private [GitHub Security Advisory](https://github.com/jotaele44/skywatcher-pr/security/advisories/new)
  for this repository.
...
This policy covers the `skywatcher-pr` source code and its CI/CD configuration.
