...
| 02 | `02_SCREENSHOT_MODEL` — Create canonical screenshot record and typed fields. | foundation_before_parameters | yes | planned |
| 03 | `03_SCREENSHOT_PROVENANCE` — Add hash, lineage, source platform, timestamp/geometry status. | foundation_before_parameters | yes | planned |
