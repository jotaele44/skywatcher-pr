...
'''
        ...
        assert lines[ruff_index + 1] == "        continue-on-error: true"
        assert lines[ruff_index + 2] == "        run: ruff check --statistics ."
  ...
  "B023",
        ...
        Path("phase0_merge_manifest.zlib.b64").write_text(encoded)
