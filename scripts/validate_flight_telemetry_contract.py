...
EXPECTED_UNITS = {
    "timestamp_utc": "ISO-8601 UTC", "latitude": "decimal_degrees", "longitude": "decimal_degrees",
    "baro_altitude_ft": "feet", "geometric_altitude_ft": "feet", "groundspeed_kt": "knots",
    "track_deg": "degrees_true", "vertical_rate_fpm": "feet_per_minute"
}
BREAKING = {
    "removing_or_renaming_field": "breaking", "changing_units": "breaking",
    "changing_null_semantics": "breaking", "adding_required_field": "breaking",
...
def validate_contract(obj, enforce_hash=False):
    ...
    required_invariants = {
        "source manifestation is preserved", "normalization does not establish source identity",
        "duplicate adjudication preserves full candidate sets", "tied top evidence remains UNRESOLVED",
        "join cardinality is reported", "proximity alone never establishes operational relationship or mission purpose"
    }
    missing = required_invariants - set(obj.get("invariants", []))
