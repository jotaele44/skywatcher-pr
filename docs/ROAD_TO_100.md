...
- PR #171 is the current aircraft spatial-truth implementation candidate; full operator-corpus execution remains pending.
- PR #170 is the deterministic multisensor replay candidate.
- PR #172 is the isolated-clone candidate.
...
1. Adjudicate #171 and execute the complete local screenshot corpus with zero false binding and bounded uncertainty.
2. Adjudicate #170 and preserve deterministic replay and provenance boundaries.
